...
For Linux / OS X and Windows, we used the gfortran compiler.  The
bash and .bat scripts reference this compiler.  You can either
download gfortran or use your own fortran compiler.  If you use
something other than gfortran, you will need to modify the scripts
that reference gfortran as the name of the compiler

The standard C/C++ psprolib library contains the FORTRAN API.
